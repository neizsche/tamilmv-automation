...
const retryWithBackoff = async (fn, maxRetries = 3, initialDelayMs = 1000, operationName = 'operation') => {
...
module.exports = { wait, ensureFolderExists, extractMovieName, formatTorrentTitle, retryWithBackoff, parseMovieName };